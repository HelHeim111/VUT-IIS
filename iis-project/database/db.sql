...
INSERT INTO `Devices` (device_name, device_type_id, description, user_id) VALUES ('KitchenThermometer', 1, 'Measures temperature in the kitchen', 2);
INSERT INTO `Devices` (device_name, device_type_id, description, user_id) VALUES ('LivingRoomHumiditySensor', 2, 'Monitors humidity in the living room', 3);
